...
- **🥇 全网最强的 DeepSeek Harness (dsh) 免费联网搜索插件：** 一条命令即刻安装 `npx -y @deepseek-ai/dsh plugin --profile web add @liustack/modsearch@5.10.1`。细节见[接入指南](docs/harness-setup.zh-CN.md#deepseek-harness-dsh)。
