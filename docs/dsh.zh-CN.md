...
```sh
npx -y @deepseek-ai/dsh plugin --profile web add @liustack/modsearch@5.10.1
```
...
```sh
npx -y @liustack/modsearch@5.10.1 doctor
```
...
```sh
npx -y @deepseek-ai/dsh plugin --profile <name> add @liustack/modsearch@5.10.1
```
