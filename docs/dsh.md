...
```sh
npx -y @deepseek-ai/dsh plugin --profile web add @liustack/modsearch@5.5.0
```
...
```sh
npx -y @liustack/modsearch@5.5.0 doctor
```
...
```sh
npx -y @deepseek-ai/dsh plugin --profile <name> add @liustack/modsearch@5.5.0
```
