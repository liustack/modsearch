# modsearch skill launcher (Windows, PowerShell 5.1 compatible).
#
...
# modsearch"); this script picks a working way to run it here.
#
...
#   1. A compatible modsearch already on PATH  -> run it directly.
