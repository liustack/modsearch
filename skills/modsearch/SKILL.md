...
1. A `modsearch` on `PATH` whose major version is 5 and is at least 5.4.2: `modsearch <args>`.
2. Otherwise, if `npx` exists: `npx --yes --package @liustack/modsearch@5.4.2 modsearch <args>`.
3. Otherwise, if `bunx` exists: `bunx --bun @liustack/modsearch@5.4.2 <args>`.
